 ...
 */
Bots.prototype.getUserData = function (botId, userId, options, callback) {
  ...
  // Validate
  try {
    if (botId === null || botId === undefined || typeof botId.valueOf() !== 'string') {
      throw new Error('botId cannot be null or undefined and it must be of type string.');
    }
  ...
  requestUrl = requestUrl.replace('{botId}', encodeURIComponent(botId));
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['BotData'](parsedResponse);
        }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Bots.prototype.setUserData = function (botId, userId, botData, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  try {
    ...
    if (botData === null || botData === undefined) {
      throw new Error('botData cannot be null or undefined.');
    }
  } catch (error) {
    return callback(error);
  }
  ...
  try {
    if (botData) {
      requestModel = new client._models['BotData'](botData);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    var statusCode = response.statusCode;
    if (statusCode !== 200 && statusCode !== 400 && statusCode !== 401 && statusCode !== 403 && statusCode !== 404 && statusCode !== 412 && statusCode !== 500 && statusCode !== 503) {
      var error = new Error(responseBody);
      error.statusCode = response.statusCode;
      error.request = httpRequest;
      error.response = response;
    ...
    if (statusCode === 503) {
      ...
      try {
        ...
        var deserializationError5 = new Error(util.format('Error "%s" occurred in deserializing the responseBody - "%s"', error, responseBody));
        deserializationError5.request = httpRequest;
        deserializationError5.response = response;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Bots.prototype.getConversationData = function (botId, conversationId, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Bots.prototype.setConversationData = function (botId, conversationId, botData, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Bots.prototype.getPerUserConversationData = function (botId, conversationId, userId, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Bots.prototype.setPerUserInConversationData = function (botId, conversationId, userId, botData, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
